...
function ToastContainer({
  ...
  return (
    <div
      className="fixed bottom-4 right-4 z-[1080] flex flex-col gap-2 pointer-events-none"
      aria-live="polite"
      aria-atomic="true"
    >
      {toasts.map((toast) => (
...
function ToastItem({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-3 px-4 py-3 rounded-md shadow-lg animate-slide-up pointer-events-auto min-w-[300px] max-w-md",
        variants[toast.type]
      )}
      role="alert"
    >
